# FULL DOCTOR'S APP WITH CONSULTATION FLOWS ADDED

# CONSULTATION FLOW:
"""
    - Doctor should be able to write consultations(medicines)
    - Consultation : - bp low, bp high, sugar, temperature, height, weight, allergies, follow_up
"""
